...
diary(filename);
 ...
 m0 = 10^-5 * input("Enter the value of 'Mass flow rate (mͦ) ' in Kg/s (*10^-5) : ") ;
 di = 10^-3 * input("Enter the value of 'inner dia of Bare fin tube (di)' in mm : ") ;  % converted to m
 meu_h = 10^-6 * input("Enter the value of 'co-efficient of viscosity of hot stream at mean temperature μ (h)' in μPa-s : ") ; % converted to Pa-s
 Dc = 10^-3 * input("Enter the value of 'Cooler diameter (Dc)' in mm  : ") ; % converted to m
Dm = 10^-3 * input("Enter the value of 'Mandrel Diameter (Dm)' in mm  : ") ; % converted to m
k_h = 10^-3 * input("Enter the value of 'Thermal conductivity at mean temperature k (h)' in mW/m-K : ") ; % converted to W/m-K
rho_h = input("Enter the value of 'Density at mean temperature ρ (h)' in Kg/m^3 : ") ;
H1 = 10^3 * input("Enter the value of ' H1 ' in KJ/Kg : "); % J/Kg
H5 = 10^3 * input("Enter the value of ' H5 ' in KJ/Kg  : "); % J/Kg
H2 = 10^3 * input("Enter the value of ' H2 '  in KJ/Kg : "); % J/Kg
 C_h = 10^3 * input("Enter the value of ' Cp of hot stream at mean temperature ' in KJ/Kg-K : ") ; % J/Kg-K

H_liq = 10^3 * input("Enter the value of ' H (liq)'  in KJ/Kg : "); % J/Kg
...
while true
    ...
    switch choice
        ...
        case 9, H1 = 10^3 * input("Enter the value of ' H1 ' in KJ/Kg : ");
        case 10, H5 = 10^3 * input("Enter the value of ' H5 ' in KJ/Kg  : ");
        case 11, H2 = 10^3 * input("Enter the value of ' H2'  in KJ/Kg : ");
        case 12, H_liq = 10^3 * input("Enter the value of ' H (liq)'  in KJ/Kg : ");
        case 13, C_h = 10^3 * input("Enter the value of ' Cp of hot stream at mean temperature ' in KJ/Kg-K : \n") ;
    end
end
...
H_vap = H5 ;
delta_H_max = H1 - H5 ;
fprintf("The Value of ∆H max in KJ/Kg : %d \n",delta_H_max * 10^-3 ) ;
H3 = H2 - delta_H_max ;
fprintf("The Value of H3 in KJ/Kg : %d \n",H3 * 10^-3) ;
x_num = H_vap - H3 ;
x_den = H_vap - H_liq ;
x = x_num / x_den ;
...
delta_H = H_vap - H_liq ;
fprintf("The Value of ∆H in KJ/Kg is : %d \n",delta_H * 10^-3) ;
Q_r = m0 * x * delta_H ;
fprintf("The Value of Qr in watts is : %d \n",Q_r) ;
...
Ah = (pi/4)* (di^2) ;
fprintf("The Value of Ah in m^2 is : %d \n",Ah) ;
G_h = m0 / Ah ;
fprintf("The Value of Gh Kg/s-m^2 is : %d \n",G_h) ;

De_h = di ;
Dh = (Dc + Dm)/2 ;
fprintf("The Value of Dh (Hydraulic diameter of the coil) in mm is : %d \n",Dh * 10^3) ;
 
Re_h = (De_h * G_h) / meu_h ;
fprintf("The Value of Reynolds Number for hhot stream is : %d \n",Re_h) ;

% if Re_h < 2300  
 %   fprintf("The flow is Laminar.\n ");
  %  Nu_h = 3.66 ;
   % fprintf("The value of Nusselt Number is : %d \n",Nu_h);
%else
...
fprintf("The Value of Nu_h is : %d \n",Nu_h) ;
 ...
 h_h = (k_h * Nu_h)/De_h ;
fprintf("The Value of h_h in W/m^2-K : %d \n",h_h) ;
a = -0.25 ;
f_h = 0.046 * (Re_h^a) ;
...
fprintf("\n");
 ...
 n = 10^3 * input("Enter the value of 'Number of fins per mm '  in mm : ") ; % per m
g_f = 10^-3 *input("Enter the value of 'Gap between two fins ' in mm  : ") ; % m
 d_of = 10^-3 *input("Enter the value of ' Outer diameter of finned tubes ' in mm  : ") ; % m
d_ofb = 10^-3 *input("Enter the value of 'Outer diameter of finned tube without fins'  in mm : ") ; % m
meu_c = 10^-6 *input("Enter the value of 'co-efficient of viscosity of cold stream at mean temperature μ (c)' in μPa-s : ") ; % Pa-s
 k_c = 10^-3 *input("Enter the value of 'Thermal conductivity at mean temperature k (c)' in mW/m-K: ") ; % W/m-K
 rho_c = input("Enter the value of 'Density at mean temperature ρ (c)' in Kg/m^3 : ") ;
 L_f = 10^-3 *input("Enter the value of 'L_f'  in mm : ") ; % m
 K_f = input("Enter the value of 'K_f' in W/mK : ") ;
tf = 10^-3 *input("Enter the value of 'tf'  in mm : ") ; % m
neta_oh = input("Enter the value of 'neta_oh' : ") ;
C_c = 10^3 * input("Enter the value of 'Cp of cold stream at mean temperature ' in KJ/Kg-K : ") ; % J/Kg-K
...
while true
    ...
    switch choice
        ...
        case 13, C_c = 10^3 * input("Enter the value of 'Cp of cold stream at mean temperature ' in KJ/Kg-K : ") ;
...
fprintf("The Value of G_c in Kg/s-m^2 : %d \n",G_c) ;
 A_w = (((pi/4) * (d_of^2 - d_ofb^2) * 2) + pi * d_ofb * g_f ) * Nf ;
fprintf("The Value of A_w in m^2 : %d \n",A_w) ;
V_fr = (pi/4) * (d_of^2 - d_ofb^2) * g_f * Nf ;
 fprintf("The Value of V_fr in m^2 : %d \n",V_fr) ;
De_c = 4 * (V_fr / A_w) ;
 fprintf("The Value of De_c in mm : %d \n",De_c * 10^3) ;
 Re_c = (De_c * G_c) / meu_c ;
 fprintf("The Value of Reynolds Number is : %d \n",Re_c) ;
...
fprintf("The Value of Nu_c is : %d \n",Nu_c) ;
 ...
 h_c = (k_c * Nu_c)/De_c ;
 fprintf("The Value of h_c in W/m^2-K : %d \n",h_c) ;
f_c = 1.902 * (Re_c^-0.3) ;
...
fprintf("The Value of A_f in mm^2 : %d \n",A_f * 10^6) ;
V_f = (pi/4)* (d_of^2 - d_ofb^2)*tf;
fprintf("The Value of V_f in mm^3 : %d \n",V_f * 10^9) ;
 delta = V_f / A_f ;
fprintf("The Value of delta in m : %d \n",delta) ;
b = h_c / (K_f * delta) ;
...
meu_h3 = 10^-6 * input("Enter the value of 'co-efficient of viscosity of hot stream at T3 μ (h)' in μPa-s : ");
...
cp3 = 10^3 * input("Enter Cp of Hot Stream at T3 in KJ/Kg-K : ");
cv3 = 10^3 * input("Enter Cv of Hot Stream at T3 in KJ/Kg-K : ");
gamma = cp3 / cv3;
fprintf("The value of r at T3 is : %d\n",gamma);

R = input("Enter the R'specific' (Specific gas Constant) for the gas : ") ;
